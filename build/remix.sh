...
apt-get purge -y gnome-initial-setup gnome-control-center gnome-calendar gnome-characters gnome-control-center-data gnome-control-center-faces gnome-desktop3-data \
gnome-font-viewer gnome-initial-setup gnome-keyring gnome-keyring-pkcs11 gnome-logs \
